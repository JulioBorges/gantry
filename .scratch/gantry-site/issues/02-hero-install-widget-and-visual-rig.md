...
- [x] Hero displays the primary tagline, value proposition, status badges, and crane visual motif.
- [x] Quick install widget provides switchable tabs for supported harnesses with accurate CLI commands and flags.
- [x] Copy button copies the selected installation command to the clipboard and gives clear visual feedback.
- [x] Playwright test validates hero rendering, tab selection switching, copy button interaction, and mobile responsiveness.
