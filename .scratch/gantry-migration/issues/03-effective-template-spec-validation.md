...
- 2026-09-13 — Critic refuted after the correction budget was spent: spec.py still validates incomplete Scenario blocks outside gherkin fences. Required fix: restrict Scenario discovery and validation exclusively to gherkin fences, with a regression test. Issue worktree retained: /Users/julioborges/src/personal/gantry-issue-03 (branch gantry/gantry-migration-03).
